...
#[rstest]
fn this_week_report(#[values("this-week", "tw")] this_week: &str) {
...
#[rstest]
fn last_week_report(#[values("last-week", "lw")] last_week: &str) {
    let content = r"## TT 2020-01-01
    - #dev 1h Task1
    ## TT 2020-01-02
    - #dev 2h Task2
...
#[rstest]
fn this_month_report(#[values("this-month", "tm")] this_month: &str) {
    let content = r"## TT 2020-01-01
    - #dev 1h Task1
    ## TT 2020-01-31
    - #dev 2h Task2
