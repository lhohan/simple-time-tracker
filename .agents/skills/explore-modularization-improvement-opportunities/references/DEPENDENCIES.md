...
Third-party services (Stripe, Twilio, etc.) you don't control. Inject a test double at the boundary. The deepened module takes the external dependency as an injected port, and tests provide an appropriate test double implementation.
